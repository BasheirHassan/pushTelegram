 ...
 * TomIT
 * 28-11-2013
 * Module to setup the PushTelegram functionality
 */
...
class ControllerExtensionModulePushTelegram extends Controller {
    ...
    public function index(){
        ...
        //Get the settings
        if (isset($this->request->post['pushtelegram_userKey'])) {
            $data['settings'] = $this->request->post['pushtelegram_userKey'];
        ...
        $data['action'] = $this->url->link('extension/module/pushtelegram', 'user_token=' . $this->session->data['user_token'], 'SSL');
