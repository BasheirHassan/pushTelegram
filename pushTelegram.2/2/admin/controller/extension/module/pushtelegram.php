...
class ControllerExtensionModulePushTelegram extends Controller
{
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/pushtelegram', 'token=' . $this->session->data['token'], 'SSL')
        );
        ...
        $data['testUrl'] = $this->url->link('extension/module/pushtelegram/testToken', 'token=' . $this->session->data['token'], 'SSL');
        $data['action'] = $this->url->link('extension/module/pushtelegram', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('extension/module/pushtelegram.tpl',$data));
    }
